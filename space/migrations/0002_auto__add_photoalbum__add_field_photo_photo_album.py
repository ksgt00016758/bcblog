...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.send_create_signal('space', ['PhotoAlbum'])

        # Adding field 'Photo.photo_album'
        db.add_column('photo', 'photo_album',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['space.PhotoAlbum']),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Photo.photo_album'
        db.delete_column('photo', 'photo_album_id')
    ...
    models = {
        ...
        'space.photo': {
            ...
            'likers': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['auth.User']", 'symmetrical': 'False'}),
